...
<p>1) We used a cache to store our values for searching (This was done efficiently using a hashMap)<br>
...
8) We used HashSets to get rid of all duplicate Genres<p>