...
function reload(of, li, orb, ti, yr, dr, fn, ln) {
	
    window.location.href = "./AdvanceSearch?limit=" + li + "&offset=" + of + "&orderby=" + orb + "&title=" + ti + "&year=" + yr + "&director=" + dr + "&first_name=" + fn + "&last_name=" + ln;
 ...
 */
    ...
    if(num_of_movies > (offset+limit))
        reload(offset+limit, limit, orderby, title, year, director, fName, lName);
...
%>  
        ...
        <div id="navBarBottom">
            ...
            <div id="itemsPerPage">
                ...
                <a href="#" class="pageCount" onclick = "reload(offset, 5, orderby, title, year, director, fName, lName);">5</a>
                <a href="#" class="pageCount" onclick = "reload(offset, 10, orderby, title, year, director, fName, lName);">10</a>
                <a href="#" class="pageCount" onclick = "reload(offset, 15, orderby, title, year, director, fName, lName);">15</a>
                <a href="#" class="pageCount" onclick = "reload(offset, 20, orderby, title, year, director, fName, lName);">20</a>
                <a href="#" class="pageCount" onclick = "reload(offset, 25, orderby, title, year, director, fName, lName);">25</a>
            </div>
        </div>
    </div>
</body>
